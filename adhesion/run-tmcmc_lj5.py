...
e["Problem"]["Computational Model"] = model_lj5
...
e["Distributions"][1]["Name"] = "Uniform 3"             #[Sigma]
...
e["Variables"][1]["Prior Distribution"] = "Uniform 3"
...
# General Settings
path = "_result_lj5_" + str(cJobs).zfill(2) + "_"  + solver
...
e['Problem']['Execution Model'] = model_lj5
