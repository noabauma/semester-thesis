...
e["Problem"]["Reference Data"] = getReferenceData4()
e["Problem"]["Computational Model"] = model_lj4
...
e["Distributions"][1]["Maximum"] = 4.0

e["Distributions"][2]["Name"] = "Uniform 2"             #rc
e["Distributions"][2]["Type"] = "Univariate/Uniform"
e["Distributions"][2]["Minimum"] = 10.0
...
if solver == 'CMAES':
    ...
    e['Solver']['Number Live Points'] = 500
...
# General Settings
path = "_result_lj4_" + str(cJobs).zfill(2) + "_"  + solver
...
e['Problem']['Execution Model'] = model_lj4
